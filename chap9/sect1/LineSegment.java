...
public class LineSegment {
   ...
   public String toString() {
      ...
      return String.format("[%s; %s; length = %s; slope = %s]", 
              endPoint1, endPoint2, length, slope);
   }

   /**
    * Test program to illustrate conversion of a line segment to a 
    * string and treatment of a line segment with infinite slope.
    */
