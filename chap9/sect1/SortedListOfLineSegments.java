...
public class SortedListOfLineSegments {
   ...
   /**
    * Test program that adds ten line segments with random endpoints 
    * to a list and then traverses the list to verify that the 
    * objects are stored in length order.
    */
   public static void main(String[] args) {
      ...
      // Verify that line segments are stored in length order.
