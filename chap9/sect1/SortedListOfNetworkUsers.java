...
public class SortedListOfNetworkUsers {
   ...
   /**
    * Test program that adds four network users to a list and then 
    * traverses it to verify that the objects are stored in order by 
    * login name.
    */
   public static void main(String[] args) {
      SortedListOfNetworkUsers users = 
              new SortedListOfNetworkUsers();
      ...
      // Verify that users are stored in login order.
